...
public class MainActivity extends AppCompatActivity {
    ...
    ByteBuffer inputs;      // tflite model 입력
    float[][] outputs = new float[1][4];    // tflite model 출력(라벨 개수에 맞게 크기 조정)
    ...
    private void logLandmark(HandsResult result) {
        ...
        int i = 0;
        int j = 0;
        double[] arr = new double[42];  // 21개 점의 x, y serialize된 데이터
